...
%% SUBSTRATE POSITION
Substrate_pos=3;                    % Substrate position is needed for the generation profile

d_layer={10 10 20 10 10};       %µm
...
pbb=46; % [mm]
wbb=0.0001;%2.48; % [mm] The busbar share can be set to zero by inserting a low value such as 0.0001

grid.pos={0 0 1 1 0}; %On top of the layer. No grid if all are 0.
